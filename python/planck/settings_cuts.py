...
CamSpec = [batchJob.dataSet(['CamSpecHM', 'TT', 'lowl', tauname], ['nonclik.ini', 'CAMspec_TT.ini', 'lowl.ini', tauprior])]
...
covNameMappings = {'v910CMH':'CamSpec', 'CamSpecHM':'CamSpec', 'plikHMv17':'plik', 'plikDSv16sz':'plik', 'plikHMv16sz':'plik',
