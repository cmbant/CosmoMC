...
!JD 08/13 changed to subroutine to prevent stops and added error flag 
  subroutine yp_bbn(ombh2_in,deltan_in,yp,error)   
    real(mcp) :: ombh2_in,deltan_in
    real(mcp), intent(out) :: yp
