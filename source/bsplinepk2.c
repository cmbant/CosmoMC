...
void dopksmoothbspline_(double *kvals, double *lnpklinear, double *lnpksmooth, int *npts)  {
	...
	gsl_vector_set(mybreaks,0,(0.01*0.7));
	gsl_vector_set(mybreaks,1,(0.0135));
	gsl_vector_set(mybreaks,2,(0.0261));
	gsl_vector_set(mybreaks,3,(0.0504));
	gsl_vector_set(mybreaks,4,(0.0973));
	gsl_vector_set(mybreaks,5,(0.1878));
	gsl_vector_set(mybreaks,6,(0.3626));
	gsl_vector_set(mybreaks,7,(0.7));
