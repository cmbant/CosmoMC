...
public:
    ...
    Voigtprofile_Dawson phi_HeI_Lya_S;
    Voigtprofile_Dawson phi_HeI_Lya_S_full_Gamma; // includes the full line width
    Voigtprofile_Dawson phi_HeI_Lyn_S[11];
    Voigtprofile_Dawson phi_HeI_23p_1s2;
    Voigtprofile_Dawson phi_HeI_23p_1s2_full_Gamma; // includes the full line width
