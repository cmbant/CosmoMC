...
{
    cout << " Load_fcorr:: Loading correction factor for DPesc due to HI : " << fname << endl;
                 ...
                 Photoionization_cross_section_SH &H1s)
{
    ...
    double Dpij=DPesc_appr_I_sym(Te, pd*eta_S, eta_c, HeIA.phi_HeI_Lya_S, H1s, P_d*1.0e-5);
    double P=P_d+Dpij;
