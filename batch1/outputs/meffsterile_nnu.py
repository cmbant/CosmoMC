...
params = g.get_param_array(roots[0], ['meffsterile','nnu'])
g.settings.setWithSubplotSize(4)
g.settings.axes_fontsize = 24 #4 + 3*4
g.settings.lab_fontsize = 32
g.settings.lw_contour = 0.2
g.alpha_filled_add = 1.0
g.setAxes(params,lims=[0.0, 1.0, 3.046, 4.8], pos=[0.15,0.15,0.60,0.80])
...
text(0.2, 4.6, s.WPhighL ,color='#E03424',fontsize=24)
text(0.2 ,4.4, s.WPhighL+'+BAO' ,color='#006FED',fontsize=24)

g.export('meffsterile_nnu')
