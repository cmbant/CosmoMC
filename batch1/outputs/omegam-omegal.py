...
roots = ['base_omegak_planck_CAMspec_lowl_lowLike_highL','base_omegak_planck_CAMspec_lowl_lowLike_highL_post_lensing','base_omegak_planck_CAMspec_lowl_lowLike_highL_BAO']
