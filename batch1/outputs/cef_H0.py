...
params = g.get_param_array(roots[0], ['cef','H0'])
...
g.setAxes(params,lims=[0.95, 1.05, 50, 100], pos=[0.15,0.15,0.60,0.80])
...
text(0.96, 95, r'\textit{WMAP}9', color='#E03424',fontsize=24)
text(0.96, 91, s.WP, color='#006FED',fontsize=24)
text(0.96, 87, s.WP+'+BAO', color='#006B30',fontsize=24)
