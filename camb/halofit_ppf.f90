    ...
    ! Dec 14: Suggested change from Simeon Bird to avoid issues with very large Omm and neutrinos
...
101     continue
    ...
    ph=ph/(1+xmu*y**(-1)+xnu*y**(-2))*(1+fnu*max(0.977-18.015*(omm0-0.3),0._dl))
