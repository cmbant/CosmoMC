...
def ns_N(N, p):  # solved used above expresion for N_r_ns, but naive expression for N
...
plt.text(0.954, 0.128, 'Convex', size=7, rotation=-21, color='k',
         ha="center", va="center")
plt.text(0.954, 0.115, 'Concave', size=7, rotation=-21, color='k',
         ha="center", va="center")
